...
*
* COPYRIGHT (c) 2019 WÃ¼rth Elektronik eiSos GmbH & Co. KG
*
***************************************************************************************************
**/
...
{
	if (WE_FAIL == I2C_ReadReg((uint8_t)PADS_DEVICE_ID_REG, 1, devID))
	return WE_FAIL;
...
int8_t PADS_setOutputDataRate(PADS_output_data_rate_t odr)
{
	...
	if (WE_FAIL == I2C_ReadReg((uint8_t)PADS_CTRL_1_REG, 1, (uint8_t *)&ctrl_reg_1))
	return WE_FAIL;

	ctrl_reg_1.pads_outputDataRate = odr;

	if (WE_FAIL == I2C_WriteReg((uint8_t)PADS_CTRL_1_REG, 1, (uint8_t *)&ctrl_reg_1))
	return WE_FAIL;
...
int8_t PADS_getOutputDataRate(PADS_output_data_rate_t* odr)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_CTRL_1_REG, 1, (uint8_t *)&ctrl_reg_1))
	return WE_FAIL;

	*odr = (PADS_output_data_rate_t)ctrl_reg_1.pads_outputDataRate;
	return WE_SUCCESS;
}
...
int8_t PADS_setLowPassFilter(PADS_state_t filterStatus)
{
	...
	ctrl_reg_1.pads_enLowPassFilter = filterStatus;
...
int8_t PADS_getLowPassFilterStatus(PADS_state_t *filterStatus)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_CTRL_1_REG, 1, (uint8_t *)&ctrl_reg_1))
	return WE_FAIL;
	*filterStatus = (PADS_state_t)ctrl_reg_1.pads_enLowPassFilter;
...
int8_t PADS_setLowPassFilterConf(PADS_filter_conf_t conf)
{
	...
	ctrl_reg_1.pads_lowPassFilterConfig = conf;
...
int8_t PADS_getLowPassFilterConf(PADS_filter_conf_t *conf )
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_CTRL_1_REG, 1, (uint8_t *)&ctrl_reg_1))
	return WE_FAIL;
	*conf = (PADS_filter_conf_t)ctrl_reg_1.pads_lowPassFilterConfig;
...
int8_t PADS_setBlockDataUpdate(PADS_state_t bdu)
{
	...
	ctrl_reg_1.pads_blockDataUpdate = bdu;
...
int8_t PADS_getBlockDataUpdateState(PADS_state_t *bdu)
{
	...
	*bdu = (PADS_state_t)ctrl_reg_1.pads_blockDataUpdate;
	return WE_SUCCESS;
}
...
int8_t PADS_setPowerMode(PADS_pwr_mode_t mode)
{
	...
	if (WE_FAIL == I2C_ReadReg((uint8_t)PADS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))
	return WE_FAIL;

	ctrl_reg_2.pads_lowNoiseMode = mode;

	if (WE_FAIL == I2C_WriteReg((uint8_t)PADS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))
	return WE_FAIL;
...
int8_t PADS_getPowerMode(PADS_pwr_mode_t *mode)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))
	return WE_FAIL;
	*mode = (PADS_pwr_mode_t)ctrl_reg_2.pads_lowNoiseMode;
...
int8_t PADS_setAutoIncrement(PADS_state_t autoInc)
{
	...
	ctrl_reg_2.pads_autoAddIncr = autoInc;
...
int8_t PADS_getAutoIncrementState(PADS_state_t *inc)
{
	...
	if (WE_FAIL == I2C_ReadReg((uint8_t)PADS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))
	return WE_FAIL;
	*inc = (PADS_state_t)ctrl_reg_2.pads_autoAddIncr;
...
int8_t PADS_getRebootMemoryState(PADS_state_t *reboot)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))
	return WE_FAIL;
	*reboot = (PADS_state_t)ctrl_reg_2.pads_boot;
...
int8_t PADS_getBootStatus(PADS_state_t *boot)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_SOURCE_REG, 1, (uint8_t *)&int_source_reg))
	return WE_FAIL;
	*boot = (PADS_state_t)int_source_reg.pads_bootOn;
...
int8_t PADS_setIntActiveLevel(PADS_interrupt_level_t intLvl)
{
	...
	ctrl_reg_2.pads_intActiveLevel = intLvl;

	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))
	return WE_FAIL;
...
int8_t PADS_getIntActiveLevel(PADS_interrupt_level_t *intLvl)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))
	return WE_FAIL;
	*intLvl = (PADS_interrupt_level_t)ctrl_reg_2.pads_intActiveLevel;
...
int8_t PADS_setIntPinType(PADS_interrupt_pin_t intr)
{
	...
	ctrl_reg_2.pads_openDrainOnINTpin = intr;
...
int8_t PADS_getIntPinType(PADS_interrupt_pin_t *intr)
{
	...
	if (WE_FAIL == I2C_ReadReg((uint8_t)PADS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))
	return WE_FAIL;
	*intr = (PADS_interrupt_pin_t)ctrl_reg_2.pads_openDrainOnINTpin;
...
int8_t PADS_setSingleConvMode(PADS_state_t mode)
{
	...
	ctrl_reg_2.pads_oneShotbit = mode;
...
int8_t PADS_getSingleConvModeState(PADS_state_t *mode)
{
	...
	if (WE_FAIL == I2C_ReadReg((uint8_t)PADS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))
	return WE_FAIL;
	*mode = (PADS_state_t)ctrl_reg_2.pads_oneShotbit;
...
int8_t PADS_setSwreset(PADS_state_t mode)
{
	...
	ctrl_reg_2.pads_softwareReset = mode;
...
int8_t PADS_getSwresetState(PADS_state_t *mode)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))
	return WE_FAIL;
	*mode = (PADS_state_t)ctrl_reg_2.pads_softwareReset;
...
int8_t PADS_setFifoFullInt(PADS_state_t fullState)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_CTRL_3_REG, 1, (uint8_t *)&ctrl_reg_3))
	return WE_FAIL;

	ctrl_reg_3.pads_fifoFullInt = fullState;

	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_CTRL_3_REG, 1, (uint8_t *)&ctrl_reg_3))
	return WE_FAIL;
...
int8_t PADS_setFifoWtmInt(PADS_state_t WtmState)
{
	...
	ctrl_reg_3.pads_fifoThresholdInt = WtmState;
...
int8_t PADS_setFifoOvrInterrupt(PADS_state_t OvrState)
{
	...
	ctrl_reg_3.pads_fifoOverrunInt = OvrState;
...
int8_t PADS_getFifoFullState(PADS_state_t *fifoFull)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_STATUS2_REG, 1, (uint8_t *)&fifo_status2))
	return WE_FAIL;
	*fifoFull = (PADS_state_t)fifo_status2.pads_fifoFull;
...
int8_t PADS_getFifoWtmState(PADS_state_t *fifoWtm)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_STATUS2_REG, 1, (uint8_t *)&fifo_status2))
	return WE_FAIL;
	*fifoWtm = (PADS_state_t)fifo_status2.pads_fifoWtm;
...
int8_t PADS_getFifoOvrState(PADS_state_t *fifoOvr)
{
	...
	*fifoOvr = (PADS_state_t)fifo_status2.pads_fifoOverrun;
	return WE_SUCCESS;
}
...
int8_t PADS_setDrdyInt(PADS_state_t DRDYStatus)
{
	...
	ctrl_reg_3.pads_dataReadyInt = DRDYStatus;
...
int8_t PADS_getDrdyIntState(PADS_state_t *drdy)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_CTRL_3_REG, 1, (uint8_t *)&ctrl_reg_3))
	return WE_FAIL;
	*drdy = (PADS_state_t)ctrl_reg_3.pads_dataReadyInt;
...
int8_t PADS_setIntEventCtrl(PADS_interrupt_event_t ctr)
{
	...
	ctrl_reg_3.pads_intEventCtrl = ctr;
...
int8_t PADS_getIntEventCtrlState(PADS_interrupt_event_t *intEvent)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_CTRL_3_REG, 1, (uint8_t *)&ctrl_reg_3))
	return WE_FAIL;
	*intEvent = (PADS_interrupt_event_t)ctrl_reg_3.pads_intEventCtrl;
...
int8_t PADS_getTempStatus(PADS_state_t *state)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_STATUS_REG, 1, (uint8_t *)&status_reg))
	return WE_FAIL;
	*state = (PADS_state_t)status_reg.pads_tempDataAvailable;
...
int8_t PADS_getPresStatus(PADS_state_t *state)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_STATUS_REG, 1, (uint8_t *)&status_reg))
	return WE_FAIL;
	*state = (PADS_state_t)status_reg.pads_presDataAvailable;
...
int8_t PADS_getTemperOverrunStatus(PADS_state_t *state)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_STATUS_REG, 1, (uint8_t *)&status_reg))
	return WE_FAIL;
	*state = (PADS_state_t)status_reg.pads_tempDataOverrun;
...
int8_t PADS_getPressureOverrunStatus(PADS_state_t *state)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_STATUS_REG, 1, (uint8_t *)&status_reg))
	return WE_FAIL;
	*state = (PADS_state_t)status_reg.pads_presDataOverrun;
...
int8_t PADS_setAutoRefp(PADS_state_t autorep)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_CFG_REG, 1, (uint8_t *)&interrupt_Configuration_reg))
	return WE_FAIL;

	interrupt_Configuration_reg.pads_autoRefp = autorep;


	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_INT_CFG_REG, 1, (uint8_t *)&interrupt_Configuration_reg))
	return WE_FAIL;
...
int8_t PADS_getAutoRefpState(PADS_state_t *autoRefp)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_CFG_REG, 1, (uint8_t *)&interrupt_Configuration_reg))
	return WE_FAIL;
	*autoRefp = (PADS_state_t)interrupt_Configuration_reg.pads_autoRefp;
	return WE_SUCCESS;
}
...
int8_t PADS_resetAutoRefp(PADS_state_t autorep)
{
	...
	interrupt_Configuration_reg.pads_resetAutoRefp = autorep;
...
int8_t PADS_setAutoZeroFunction(PADS_state_t autozero)
{
	...
	interrupt_Configuration_reg.pads_autoZeroFunc = autozero;
...
int8_t PADS_getAutoZeroState(PADS_state_t *autoZero)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_CFG_REG, 1, (uint8_t *)&interrupt_Configuration_reg))
	return WE_FAIL;
	*autoZero = (PADS_state_t)interrupt_Configuration_reg.pads_autoZeroFunc;
	return WE_SUCCESS;
}
...
int8_t PADS_resetAutoZeroFunction(PADS_state_t autozeroRst)
{
	...
	interrupt_Configuration_reg.pads_resetAutoZeroFunc = autozeroRst;
...
int8_t PADS_setDiffPresInt(PADS_state_t diffEn)
{
	...
	interrupt_Configuration_reg.pads_diffInt = diffEn;
...
int8_t PADS_getDiffPresIntState(PADS_state_t *diffIntState)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_CFG_REG, 1, (uint8_t *)&interrupt_Configuration_reg))
	return WE_FAIL;
	*diffIntState = (PADS_state_t)interrupt_Configuration_reg.pads_diffInt;
	return WE_SUCCESS;
}
...
int8_t PADS_setLatchInt(PADS_state_t state)
{
	...
	interrupt_Configuration_reg.pads_latchedInt = state;
...
int8_t PADS_getLatchIntState(PADS_state_t *latchInt)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_CFG_REG, 1, (uint8_t *)&interrupt_Configuration_reg))
	return WE_FAIL;
	*latchInt = (PADS_state_t)interrupt_Configuration_reg.pads_latchedInt;
	return WE_SUCCESS;
}
...
int8_t PADS_setLowPresInt(PADS_state_t state)
{
	...
	interrupt_Configuration_reg.pads_lowPresInt = state;
...
int8_t PADS_getLowPresIntState(PADS_state_t *lpint)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_CFG_REG, 1, (uint8_t *)&interrupt_Configuration_reg))
	return WE_FAIL;
	*lpint = (PADS_state_t)interrupt_Configuration_reg.pads_lowPresInt;
	return WE_SUCCESS;
}
...
int8_t PADS_setHighPresInt(PADS_state_t state)
{
	...
	interrupt_Configuration_reg.pads_highPresInt = state;
...
int8_t PADS_getHighPresIntState(PADS_state_t *hpint)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_CFG_REG, 1, (uint8_t *)&interrupt_Configuration_reg))
	return WE_FAIL;
	*hpint = (PADS_state_t)interrupt_Configuration_reg.pads_highPresInt;
	return WE_SUCCESS;
}
...
int8_t PADS_setPresThrLSB(uint8_t thr)
{
	...
	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_THR_P_L_REG, 1, &thresholdLSB))
	return WE_FAIL;
...
int8_t PADS_setPresThrMSB(uint8_t thr)
{
	...
	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_THR_P_H_REG, 1, &thresholdMSB))
	return WE_FAIL;
...
{
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_THR_P_L_REG, 1, thrLSB))
	return WE_FAIL;
...
{
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_THR_P_H_REG, 1, thrMSB))
	return WE_FAIL;
...
int8_t PADS_disI2C(PADS_state_t I2CStatus)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INTERFACE_CTRL_REG, 1, (uint8_t *)&interface_ctrl))
	return WE_FAIL;

	interface_ctrl.pads_disableI2C = I2CStatus;

	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_INTERFACE_CTRL_REG, 1, (uint8_t *)&interface_ctrl))
	return WE_FAIL;
...
int8_t PADS_getI2CState(PADS_state_t *i2cState)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INTERFACE_CTRL_REG, 1, (uint8_t *)&interface_ctrl))
	return WE_FAIL;
	*i2cState = (PADS_state_t)interface_ctrl.pads_disableI2C;
	return WE_SUCCESS;
}
...
int8_t PADS_disPullDownIntPin(PADS_state_t pullDownState)
{
	...
	interface_ctrl.pads_disPullDownOnIntPin = pullDownState;
...
int8_t PADS_getPullDownIntPinState(PADS_state_t *pinState)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INTERFACE_CTRL_REG, 1, (uint8_t *)&interface_ctrl))
	return WE_FAIL;
	*pinState = (PADS_state_t)interface_ctrl.pads_disPullDownOnIntPin;
...
int8_t PADS_setSAOPullUp(PADS_state_t SaoStatus)
{
	...
	interface_ctrl.pads_pullUpOnSAOpin = SaoStatus;
...
int8_t PADS_getSAOPullUpState(PADS_state_t *saoPinState)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INTERFACE_CTRL_REG, 1, (uint8_t *)&interface_ctrl))
	return WE_FAIL;
	*saoPinState = (PADS_state_t)interface_ctrl.pads_pullUpOnSAOpin;
...
int8_t PADS_setSDAPullUp(PADS_state_t SdaStatus)
{
	...
	interface_ctrl.pads_pullUpOnSDApin = SdaStatus;
...
int8_t PADS_getSDAPullUpState(PADS_state_t *sdaPinState)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INTERFACE_CTRL_REG, 1, (uint8_t *)&interface_ctrl))
	return WE_FAIL;
	*sdaPinState = (PADS_state_t)interface_ctrl.pads_pullUpOnSDApin;
...
int8_t PADS_setFifoMode(PADS_fifo_mode_t fifoMode)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_CTRL_REG, 1, (uint8_t *)&fifo_ctrl_reg))
	return WE_FAIL;

	fifo_ctrl_reg.pads_fifoMode = fifoMode;

	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_FIFO_CTRL_REG, 1, (uint8_t *)&fifo_ctrl_reg))
	return WE_FAIL;
...
int8_t PADS_getFifoMode(PADS_fifo_mode_t *fifoMode)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_CTRL_REG, 1, (uint8_t *)&fifo_ctrl_reg))
	return WE_FAIL;
	*fifoMode = (PADS_fifo_mode_t)fifo_ctrl_reg.pads_fifoMode;
...
int8_t PADS_setStopOnThr(PADS_state_t state)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_CTRL_REG, 1, (uint8_t *)&fifo_ctrl))
	return WE_FAIL;

	fifo_ctrl.pads_stopOnThreshold = state;

	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_FIFO_CTRL_REG, 1, (uint8_t *)&fifo_ctrl))
	return WE_FAIL;
...
int8_t PADS_getStopOnThrStatus(PADS_state_t *state)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_CTRL_REG, 1, (uint8_t *)&fifo_ctrl))
	return WE_FAIL;
	*state = (PADS_state_t)fifo_ctrl.pads_stopOnThreshold;
...
int8_t PADS_setFifoThr(uint8_t fifoThr)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_WTM_REG, 1, (uint8_t *)&fifo_wtm))
	return WE_FAIL;

	fifo_wtm.pads_fifoThreshold = fifoThr;

	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_FIFO_WTM_REG, 1, (uint8_t *)&fifo_wtm))
	return WE_FAIL;
...
int8_t PADS_getFifoThr(uint8_t *fifoThr)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_WTM_REG, 1, (uint8_t *)&fifo_wtm))
	return WE_FAIL;
	*fifoThr = (uint8_t)fifo_wtm.pads_fifoThreshold;
...
int8_t PADS_getFifoFillLevel(uint8_t *fifoLevel)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_STATUS1_REG, 1, fifoLevel))
	return WE_FAIL;
...
{
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_REF_P_H_REG, 1, lowReferenceValue))
	return WE_FAIL;
...
{
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_REF_P_H_REG, 1, highReferenceValue))
	return WE_FAIL;
...
int8_t PADS_setPresOffsetLSB(uint8_t offSet)
{
	...
	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_OPC_P_L_REG, 1, &pressureOffsetLsb))
	return WE_FAIL;
...
int8_t PADS_getPresOffsetLSB(uint8_t *offSet)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_OPC_P_L_REG, 1, offSet))
	return WE_FAIL;
...
int8_t PADS_setPresOffsetMSB(uint8_t highPresureOffsetValue)
{
	...
	if (WE_FAIL == SPI_WriteReg((uint8_t)PADS_OPC_P_H_REG, 1, &pressureOffsetMsb))
	return WE_FAIL;
...
{
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_OPC_P_H_REG, 1, offSet))
	return WE_FAIL;
...
int8_t PADS_getIntStatus(PADS_state_t *intState)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_SOURCE_REG, 1, (uint8_t *)&int_source))
	return WE_FAIL;
	*intState = (PADS_state_t)int_source.pads_intStatus;
...
int8_t PADS_getLowPresIntStatus(PADS_state_t *lpState)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_SOURCE_REG, 1, (uint8_t *)&int_source))
	return WE_FAIL;
	*lpState = (PADS_state_t)int_source.pads_diffPresLowEvent;
...
int8_t PADS_getHighPresIntStatus(PADS_state_t *hpState)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_INT_SOURCE_REG, 1, (uint8_t *)&int_source))
	return WE_FAIL;
	*hpState = int_source.pads_diffPresHighEvent;
...
int8_t PADS_getRAWPressure(int32_t *rawPres)
{
	...
	if (WE_FAIL == I2C_ReadReg((uint8_t)PADS_DATA_P_XL_REG, 3, tmp))
	return WE_FAIL;

	*rawPres = (int32_t)(tmp[2] << 16);
	*rawPres |= (int32_t)(tmp[1] << 8);
	*rawPres |= (int32_t)(tmp[0]);
	//printf("raw pressure %d", rawPres);
...
int8_t PADS_getPressure(float *presskPa)
{
	...
	//printf("inside PADS_getPressure() ,");
...
int8_t PADS_getRAWTemperature(int16_t *rawTemp)
{
	...
	if (WE_FAIL == I2C_ReadReg((uint8_t)PADS_DATA_T_L_REG, 2, tmp))
	return WE_FAIL;
...
int8_t PADS_getFifoRAWPressure(int32_t *rawPres)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_DATA_P_XL_REG, 3, tmp))
	return WE_FAIL;
...
int8_t PADS_getFifoRAWTemperature(int16_t *rawTemp)
{
	...
	if (WE_FAIL == SPI_ReadReg((uint8_t)PADS_FIFO_DATA_T_L_REG, 2, tmp))
	return WE_FAIL;
...
/**
* @brief  Read the temperature value from fifo in Â°C
* @param  Pointer to Fifo Temperature Measurement
* @retval error code
*/
