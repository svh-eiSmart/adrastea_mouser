...
#define IOSEL_CFG_TB_SIZE ALT1250_GPIO_NUM
/*! @endcond */
/****************************************************************************
 * Data types
 ****************************************************************************/
...
typedef enum {
  ...
  IO_FUNC_EXT_DMA_RDY3,
  IO_FUNC_EXT_DMA_RDY4,
  IO_FUNC_UART0_CTS_N,
  IO_FUNC_UART0_RTS_N,
  IO_FUNC_UART0_TXD,
  IO_FUNC_UART0_RXD,
  ...
  IO_FUNC_LED_CTRL_LED_3,
  IO_FUNC_LED_CTRL_LED_4,
  IO_FUNC_LED_CTRL_LED_5,
  IO_FUNC_CC_IN0,
  IO_FUNC_CC_IN1,
  IO_FUNC_CC_IN2,
  IO_FUNC_CC_IN3,
  ...
  IO_FUNC_I2C1_SDA_OUT,
  IO_FUNC_I2C1_SCL_OUT,
  IO_FUNC_SPI0_SCK_OUT,
  IO_FUNC_SPI0_CS0_OUT,
  IO_FUNC_SPI0_CD_OUT,
  IO_FUNC_SPI0_MOSI_OUT,
  IO_FUNC_SPI1_SCK_OUT,
  IO_FUNC_SPI1_CS0_OUT,
  IO_FUNC_SPI1_CD_OUT,
  IO_FUNC_SPI1_MOSI_OUT,
